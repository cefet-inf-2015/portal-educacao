...
public class Corretor {
     ...
     * @param arquivoGabarito arquivo gabarito TXT
     * @return número de questões acertadas
     */
    public int corrigirProva(File file, File arquivoGabarito) {
        String [] respostaDada = null;
        try {
            respostaDada = formatarRespostas(readFile(arquivoGabarito));
