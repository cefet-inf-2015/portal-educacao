...
public class VideoCaptura {
    ...
    File temp = new File("FOTO.png");

    public void criaArquivoTemporario() throws IOException {
        ...
        ImageIO.write(imageBuffer, "PNG", temp); // Salva o arquivo na pasta de origem do arquivo. AQUI HAVERÁ A CONEXÃO COM O BD.
    ...
    public void apagaArquivoTemporario() throws IOException {
        temp.deleteOnExit();
    }
