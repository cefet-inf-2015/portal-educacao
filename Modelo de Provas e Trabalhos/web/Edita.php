	...
	$link = new mysqli_connect("cefet-inf-2015.ddns.net:43306", "root", "apenasinf-2015", "modelos");
	   ...
	   if(!$link) {
        ...
        $duracao = $_POST['duracao'];
    		 ...
    		 $query = "UPDATE cabecalho SET  valor='".$valor."', nomeEscola='".$escola."', dataProva='".$dataAplica."', dataRecebimento='".$dataRecebimento."', dataEntrega='".$dataEntrega."', titulo='".$novotitulo."', matricula='".$matricula."',
         nomeProfessor='".$elab."', numeroQuestoes='".$nQuest."', turma='".$turma."', turno='".$turno."', duracao='".$duracao."' WHERE titulo='".$titulo."'";
